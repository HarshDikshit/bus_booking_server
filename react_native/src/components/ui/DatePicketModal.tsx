...
interface DatePicketModalProps {
    visible: boolean;
    onClose: () => void;
...
const DatePicketModal: React.FC<DatePicketModalProps> = ({visible, onClose, onConfirm, selectedDate}) => {
  ...
  return (
    ...
    animationType='slide'
    >
        <View className='flex-1 justify-center' style={{backgroundColor: 'rgba(0,0,0,0, 0.5)'}}>
...
export default DatePicketModal